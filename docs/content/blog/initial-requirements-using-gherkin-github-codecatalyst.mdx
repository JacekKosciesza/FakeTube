...
You can find all of the acceptance criteria (Gherkin feature files) and components hierarchy (YAML file) in the GitHub [JacekKosciesza/CodeTube](https://github.com/JacekKosciesza/CodeTube/tree/8c0eeb30c82fe2bf937762ddaec41e7f2f4248de) repository. GitHub project is here: [CodeTube](https://github.com/users/JacekKosciesza/projects/9).
