---
title: "Initial Requirements using Gherkin, GitHub, CodeCatalyst - CodeTube #1"
date: 2025-03-31
...
Sounds like a perfect fit for our project, but is that the case with **other building blocks** needed for CodeTube? We will definitely look into that, do some **experiments** and try to **find the limits**.
...
What would be the **minimum feature set** that would **bring value** to CodeTube users?
...
Application Shell starts to look quite good - there are only elements which we need in the first version of CodeTube. Now it's **time for home page cleanup**.
...
I will start by going to [my GitHub account](https://github.com/JacekKosciesza), selecting the **"Projects tab"** and clicking the **"New Project"** button. Let's select the **"Team planning"** template, name our project **"CodeTube"** and click the **"Create project"** button.

![GitHub create project](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/5cjr683q90gz7u4xspkh.gif)

Project was successfully created, so now we can create our backlog. Click **"+ Add item"** at the bottom of the **"Todo" column**. We will name the **item "Application Shell"** and select the **"Create new issue" button**. We will select the **"JacekKosciesza/CodeTube" repository** and use **"Blank issue"** for now. We can copy paste our requirements prepared earlier as an issue **description**. Our first backlog item is ready. 
...
We will **"Start from scratch"** and name the project **"CodeTube"**. For the final confirmation let's click **"Create project"** again.
...
You can find all of the acceptance criteria (Gherkin feature files) and components hierarchy (YAML file) in the GitHub [JacekKosciesza/CodeTube](https://github.com/JacekKosciesza/FakeTube/tree/8c0eeb30c82fe2bf937762ddaec41e7f2f4248de) repository. GitHub project is here: [CodeTube](https://github.com/users/JacekKosciesza/projects/9).
